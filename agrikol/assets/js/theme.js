...
-------------------------------------*/
    ...
    if ($(".main-menu__list").length) {
        ...
        let mainNavContent = $(".main-menu__list");

        mobileNavContainer.append(mainNavContent.clone());
        ...
        if ($(".mobile-nav__container .main-menu__list li.dropdown ul").length) {
            $(".mobile-nav__container .main-menu__list li.dropdown").children("a").append('<button class="dropdown-btn"><i class="fa fa-angle-right"></i></button>');
        }
    }
    ...
    if ($(".sticky-header__content").length) {
        let navContent = document.querySelector(".main-menu").innerHTML;
        let stickyNavContainer = document.querySelector(".sticky-header__content");
        stickyNavContainer.innerHTML = navContent;
    }
